...
/**
 * Got this from [Stack Overflow](https://stackoverflow.com/questions/11501192/comparing-version-number-strings-major-minor-revision-beta) originally written by srs, includes minor modification includes converted with Kotlin
 */
object Version {
    ...
    private fun compareVersionString(str1: String?, str2: String?): Int {
        ...
        if (i < verStr1.size && i < verStr2.size) {
            ...
            try {
                ...
                diff = verStr1[i]!!.toInt().compareTo(verStr2[i]!!.toInt())
    ...
    fun versionCompare(str1: String, str2: String): Int {
        ...
        if (ret == 0) {
            ...
            ret = if (preReleaseVer1 == null && preReleaseVer2 == null) {
                0
                ...
                compareVersionString(preReleaseVer1, preReleaseVer2)
            }
        }
